    ...
    <!--[if lt IE 9]>
    <script src="<?php echo Uri::base(false);?>assets/bootstrap/js/html5shiv.js"></script>
    <script src="<?php echo Uri::base(false);?>assets/bootstrap/js/respond.min.js"></script>
    <![endif]-->