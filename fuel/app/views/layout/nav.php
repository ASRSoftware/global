        ...
        <div class="row">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="<?php echo Uri::base(false);?>">Home</a></li>
                     <li><a href="<?php echo Uri::base(false);?>">About us</a></li>
                     <li><a href="<?php echo Uri::base(false);?>">Sell & Rent</a></li>
                     <li><a href="<?php echo Uri::base(false);?>">Property</a></li>
                    <li><a href="<?php echo Uri::base(false);?>">Contact Us</a></li>
                </ul>
            </div><!-- /.navbar-collapse -->
