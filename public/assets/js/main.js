...
var menu = {
    show: function(which){
        ...
        $('.model-container .form').slideUp();
        $('.model-container .form#model-'+which).slideDown();
        $('.model-container .btn-group > .btn').removeClass('active');
        $('.model-container .btn-group > .btn-'+which).addClass('active');
        return false;
    },
    hideAll: function(){
        $('.model-container').hide();
        $('.model-container .form').hide();
        return false;
    }
}
$(function(){
